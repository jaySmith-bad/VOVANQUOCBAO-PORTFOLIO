...
const projects = [
  {
    ...
    description: "Transparent NFT charity auction platform on Sui Network. The project helps record every donation on-chain and transfers directly to those in need such as: Steps of Hope, Tet Gifts for poor patients, and Clean Water Support.",
    fullStory: "During the development of this project, the biggest challenge was ensuring absolute transparency of cash flow from donors to recipients. I applied the 'Direct-to-Receiver' model through Move Smart Contracts, eliminating intermediaries and minimizing loss risks. The biggest lesson learned was that optimizing the Object structure in Move significantly saves Gas fees for users when performing bulk auction transactions.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-300 font-normal max-w-2xl italic text-lg leading-relaxed">
            From accumulated knowledge, I realize them into technological solutions with practical value for the community.
          </p>
        </motion.div>
