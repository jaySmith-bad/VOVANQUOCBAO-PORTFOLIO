      ...
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-lg mb-10 leading-relaxed font-light">
            Building financial infrastructure on blockchains. <br className="hidden md:block" />
            Specializing in <span className="text-white font-medium border-b border-[#61dafb]/30">Sui Network (Move)</span> & <span className="text-white font-medium border-b border-purple-500/30">EVM (Solidity)</span>.
          </p>
        ...
        >
          <div className="relative w-[450px] h-[450px] md:w-[650px] md:h-[650px]">
            ...
            <div className="absolute inset-[10%] border border-white/[0.05] rounded-full flex items-center justify-center">
              ...
              >
                LOCATION: <span className="text-white">HCMC</span>
              </motion.div>
              {/* Core Tag */}
              <motion.div 
                initial={{ opacity: 0 }}
