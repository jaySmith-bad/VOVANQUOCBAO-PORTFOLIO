...
const experiences = [
  {
    ...
    description: "Tham gia đào tạo chuyên sâu về kiến trúc SUI Blockchain và ngôn ngữ Move trực tiếp từ đại diện SUI Foundation. Kết nối với cộng đồng Web3 Developer và cập nhật các xu hướng công nghệ mới nhất (DeFi, NFT). Đặc biệt, dự án đã đạt thành tích Top 5 Finalist tại cuộc thi Hackathon thuộc chuỗi sự kiện.",
    images: [
    ...
    <section id="experience" className="py-24 px-6 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h3 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">Hành Trình & Câu Chuyện</h3>
          <p className="text-gray-300 font-normal max-w-2xl italic text-lg leading-relaxed">
            Mọi dự án đều bắt đầu từ một sự tò mò. Đây là nơi tôi ghi lại những cột mốc quan trọng, từ những bước chân đầu tiên vào thế giới Web3 cho đến những thành tựu thực tế.
          </p>
        </motion.div>
