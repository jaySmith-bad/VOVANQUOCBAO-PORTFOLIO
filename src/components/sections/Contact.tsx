  ...
  const contactInfo = [
    {
      ...
      description: "Gửi phản hồi hoặc lời mời hợp tác."
    },
    {
      ...
      description: "Liên hệ trực tiếp hoặc qua Zalo để phản hồi nhanh nhất."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-300 font-normal max-w-2xl mx-auto italic text-lg leading-relaxed">
            Hành trình tuyệt vời nhất là hành trình có những người đồng hành cùng chí hướng. Hãy kết nối để cùng nhau tạo nên những giá trị mới.
          </p>
        </motion.div>
